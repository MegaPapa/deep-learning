...
# Constant to check classes balancing (for small dataset)
CLASSES_DIFFERENCE_ERROR = 25

LEARNING_LETTERS = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]

TRAIN_SET_PERCENTS = 0.60
VALIDATION_SET_PERCENTS = 0.20
TEST_SET_PERCENTS = 0.20
